...
public partial class Show_report : System.Web.UI.Page
{
    ...
    public void showDataListing()
    {
        ...
        String SQL = "SELECT * FROM show,movie,audi WHERE audi_id = show_audi_id AND movie_id = show_movie_id";
    ...
    protected void deleteData_Click(object sender, EventArgs e)
    {
        ...
        DBConnection cn = new DBConnection();
        String SQL = "DELETE FROM show WHERE show_id = @0";
        SqlCommand cmd = new SqlCommand(SQL, cn.con);
