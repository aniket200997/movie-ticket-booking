<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Change-password.aspx.cs" Inherits="Designation" %>
    ...
    <main class="container clear"> 
      ...
      <h2>Change Your Password</h2>
            <div>
                ...
                </span></label><asp:TextBox ID="old_password" runat="server" TextMode="Password"></asp:TextBox>
            </div>
            <div>
                ...
                </span></label><asp:TextBox ID="new_password" runat="server" TextMode="Password"></asp:TextBox>
            </div>
            <div>
                <label for="email">Confirm Password<span>*<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="confirm_password" ErrorMessage="Plzz enter confirm password"></asp:RequiredFieldValidator>
                </span></label><asp:TextBox ID="confirm_password" runat="server" TextMode="Password"></asp:TextBox>
            </div>
            <div>
